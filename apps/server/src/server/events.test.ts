...
test("upsertRepoAndPublish keeps settings an operator already set", () => {
  ...
  repos.update.run({ $full_name: "keep/settings", $prompt: "custom", $model: "m", $enabled: 1, $deny_test_commands: null, $auto_merge: null, $merge_method: null , $refine_enabled: null, $refine_prompt: null, $implement_enabled: null, $implement_label: null, $implement_prompt: null, $refine_model: null, $implement_model: null});
