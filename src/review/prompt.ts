...
// The configurable review focus/voice. Users override this per-repo or via the
// dashboard default. The fixed output structure and posting protocol live in the
// `fouine` opencode agent's system prompt (opencode-config/agent/fouine.md), so
